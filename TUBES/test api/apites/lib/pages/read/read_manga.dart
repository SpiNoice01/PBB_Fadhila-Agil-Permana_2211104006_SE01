...
class _ReadMangaScreenState extends State<ReadMangaScreen> {
  ...
  Color backgroundColor = Colors.white; // Default to white background
  Color appBarColor =
      Colors.white.withOpacity(0.8); // Default to white background
  Color textColor = Colors.black; // Default to black text
  Color iconColor = Colors.black; // Default to black icons
